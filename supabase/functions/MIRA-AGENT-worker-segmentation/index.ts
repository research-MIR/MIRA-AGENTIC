...
// --- MOCKED PROMPT FOR DEBUGGING ---
const systemPrompt = `You are a helpful assistant. You will be provided with two images labeled 'PERSON IMAGE' and 'GARMENT IMAGE', and an optional user prompt. Your task is to briefly describe both images in a single markdown paragraph.`;
