export const translations = {
  ...
  en: {
    ...
    newSeed: "New Seed",
    // VTO Page
    vtoDescription: "A suite of tools for virtual try-on. Use 'Single Try-On' for detailed, individual creations or 'Batch Process' to generate multiple variations at once.",
