...
import { Wand2, Loader2, X, PlusCircle, Sparkles } from "lucide-react";
...
export const BatchInpaintPro = () => {
    ...
    const handleBatchSubmit = async () => {
        ...
        const pairs = precisePairs.map(p => ({...p, is_helper_enabled: p.isHelperEnabled}));
        ...
        try {
            ...
            showSuccess(`${pairs.length} jobs have been queued for processing.`);
