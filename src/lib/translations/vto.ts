export const vtoTranslations = {
  it: {
    ...
    vtoHelpSingleDesc: "Questa è la modalità standard per generare un'immagine di prova. Carica un'immagine di una persona e un'immagine di un indumento. Puoi scrivere un prompt manually o usare l'opzione 'Auto-Genera' per far sì che l'IA crei un prompt dettagliato per te.",
