...
serve(async (req) => {
  ...
  try {
    ...
    console.log("[SegTestWorker] Function invoked with payload:", { person_image_url, garment_image_url, user_prompt, user_id });
    ...
    console.log("[SegTestWorker] Calling Gemini API without strict schema...");
