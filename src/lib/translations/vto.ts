...
**Nota:** Il job potrebbe apparire nella lista dei "Job Recenti" anche dopo un minuto. Attendi prima di riprovare. Se non appare, chiedi assistenza.
    ...
    armadio: "Armadio",
    myWardrobe: "Il Mio Armadio",
    wardrobeDescription: "Sfoglia e seleziona gli indumenti che hai salvato in precedenza.",
    useSelectedGarments: "Usa {count} Indumenti Selezionati",
    noGarmentsSaved: "Nessun indumento salvato.",
    noGarmentsSavedDescription: "Carica un indumento in una delle altre modalità per salvarlo automaticamente qui.",
  },
  en: {
    proMode: "Pro Mode",
...
**Note:** The job may appear in the "Recent Jobs" list after a minute. Please wait before trying again. If it doesn't appear, ask for assistance.
    ...
    wardrobeDescription: "Browse and select garments you have previously saved.",
    useSelectedGarments: "Use {count} Selected Garment(s)",
    noGarmentsSaved: "No saved garments.",
    noGarmentsSavedDescription: "Upload a garment in one of the other modes to automatically save it here.",
  },
};