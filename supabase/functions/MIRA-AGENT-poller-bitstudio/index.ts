  ...
  try {
    ...
    if (jobStatus === 'completed') {
      ...
      if (originalGarmentUrl) {
          console.log(`[BitStudioPoller][${job.id}] Found reference garment URL. Starting verification step...`);
          try {
          ...
          console.log(`[BitStudioPoller][${job.id}] No reference garment URL found. Skipping verification step.`);
      }
