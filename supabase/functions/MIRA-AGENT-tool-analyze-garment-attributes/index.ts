...
*   **\`type_of_fit\`**: Your assessment of which part of the body the garment covers. It MUST be one of these exact string values: **'upper_body'**, **'lower_body'**, **'full_body'**, or **'shoes'**. Do NOT use spaces.
