...
**Nota:** Il job potrebbe apparire nella lista dei "Job Recenti" anche dopo un minuto. Attendi prima di riprovare. Se non appare, chiedi assistenza.
    ...
    selectGarmentPack: "Seleziona Pack di Capi",
    selectGarmentPackPlaceholder: "Scegli un pack per l'auto-completamento...",
    selectGarmentPackDesc: "L'IA userà i capi di questo pack per completare l'outfit.",
  },
  en: {
    proMode: "Pro Mode",
...
**Note:** The job may appear in the "Recent Jobs" list after a minute. Please wait before trying again. If it doesn't appear, ask for assistance.
    ...
    selectGarmentPack: "Select Garment Pack",
    selectGarmentPackPlaceholder: "Choose a pack for auto-complete...",
    selectGarmentPackDesc: "The AI will use garments from this pack to complete the outfit.",
  },
};