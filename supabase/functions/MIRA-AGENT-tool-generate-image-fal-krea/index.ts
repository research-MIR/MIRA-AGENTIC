...
const REQUIRED_LORAS = [
    {
        path: 'https://huggingface.co/jhguighukjghkj/Test/resolve/main/v15-bf16.safetensors',
        params: { scale: 1.0 }
    },
    {
        path: 'https://huggingface.co/jhguighukjghkj/Test/resolve/main/fix-v2.safetensors',
        params: { scale: 1.0 }
    }
];
